...
#102.26 
Dc = 2.562*25.4 #(8*3/8)*25.4 #2*25.4 #mm Diametro de la camara 
Df = 4 # in, diametro fuselaje

Dt = 18.31 #(16/16/np.sqrt(2))*25.4 # mm, de pulgadas a mm [(in)*(mm/in)]
L_t = 3 # mm
L_Dt = L_t/Dt
...
Dp =  1.02*25.4 #(16*1/16)*25.4 # mm, de pulgadas a mm [(in)*(mm/in)] # Diametro del port
